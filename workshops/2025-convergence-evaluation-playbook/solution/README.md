...
Before running any command, inside the `2025-convergence-evaluation-playbook/solution` directory, you have to set up your environment:
...
```bash
2025-convergence-evaluation-playbook/solution/
    ├── data/                       # Data files
